...
#pragma mark - YWPageControlProtocol
- (void)setAfterViewControllers:(UIViewController *)viewController {
    [self setController:viewController animated:YES isAbove:NO];
}

- (void)setBeforeViewControllers:(UIViewController *)viewController {
    [self setController:viewController animated:YES isAbove:YES];
...
- (void)setViewControllers:(NSArray<UIViewController *> *)viewControllers direction:(UIPageViewControllerNavigationDirection)direction animated:(BOOL)animated completion:(void (^)(BOOL))completion {
    [self setController:viewControllers[0]];
}
